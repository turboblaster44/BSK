...
from utils import decryptAES, is_rsa_private_key, is_rsa_public_key
...
class MainWindow(QWidget):
    ...
    def saveToFile(self, filecontents, name, filter="binary files (*.bin)"):
        file_path, _ = QFileDialog.getSaveFileName(
            self, "Save Encrypted Private Key", name, filter)
